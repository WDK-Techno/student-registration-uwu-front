...
const AddFacultyModel = ({ onHide, show, disabled, editable, item, changed }) => {
        ...
        <div className='d-flex flex-column'>
          <div className='mt-3'>
            <div className="has-validation">
              <label htmlFor="academicYear" className="form-label text-dark">Faculty Name</label>
              <input type="text" className={`form-control ${error.academicYear ? "is-invalid" : ""}`} name='academicYear' value={formData.academicYear} onChange={handleInputChange} id="academicYear" placeholder="Faculty Name" disabled={disabled} required />
          ...
          <div className='mt-3'>
            <div className="">
              <label htmlFor="enrolledBatch" className="form-label text-dark">Faculty Short Name</label>
              <input type="text" name='enrolledBatch' value={formData.enrolledBatch} onChange={handleInputChange} className={`form-control ${error.enrolledBatch ? "is-invalid" : ""}`} id="enrolledBatch" placeholder="Faculty Short Name" disabled={disabled} />
              <div className="invalid-feedback">
                This field is required.
              </div>
            </div>
