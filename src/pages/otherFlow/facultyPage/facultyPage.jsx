...
import AddFacultyModel from '../../../components/models/addOuModel/addFacultyModel';
...
const FacultyPage = () => {
  ...
  const tableHeading = [
    { label: "ID", value: "id" },
    { label: "Faculty Name", value: "ouName" },
    // { label: "OU Logo", value: "ouLogo" },
    { label: "Faculty Short Name", value: "facultyShortName" },
  ...
  return (
    <>
      {pageLoading ? (
        ...
        <>
          <div className='text-cl-primary'>Faculty Page</div>
